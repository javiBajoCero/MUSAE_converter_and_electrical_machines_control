...
typedef struct {
  ...
  int32_T LOWSIDESOFTHEINVERTERCLAMPEDTOG;
                         /* '<Root>/LOW SIDES OF THE INVERTER CLAMPED TO GND' */
...
struct P_blikingled_28069M_launchpad_T_ {
  ...
  real_T Constant1_Value;              /* Expression: 1
                                        ...
                                        */
  real_T SineWave_Amp;                 /* Expression: 2300/2
 ...
 * Block '<Root>/Sawtooth Generator' : Unused code path elimination
 */
 ...
 * '<S1>'   : 'blikingled_28069M_launchpad/Ramp'
 */
