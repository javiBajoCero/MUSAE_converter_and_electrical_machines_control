 ...
 * C source code generated on : Mon Mar  4 17:29:06 2024
 *
...
void blikingled_28069M_launchpad_step(void)
{
  ...
  /* S-Function (c280xgpio_do): '<Root>/LOW SIDES OF THE INVERTER CLAMPED TO GND' incorporates:
...
void blikingled_28069M_launchpad_initialize(void)
{
  ...
  /* External mode info */
  blikingled_28069M_launchpad_M->Sizes.checksums[0] = (1235370691U);
  blikingled_28069M_launchpad_M->Sizes.checksums[1] = (4193127283U);
  blikingled_28069M_launchpad_M->Sizes.checksums[2] = (1200959468U);
  blikingled_28069M_launchpad_M->Sizes.checksums[3] = (1678561662U);
  ...
  /* Start for S-Function (c280xgpio_do): '<Root>/LOW SIDES OF THE INVERTER CLAMPED TO GND' */
  EALLOW;
